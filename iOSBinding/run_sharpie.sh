...
#
sharpie bind -output ./ -sdk iphoneos11.4 -namespace ZoomAuthentication ./ZoomAuthentication.framework/Headers/ZoomAuthentication-swift.h -scope ./ZoomAuthentication.framework/Headers/ &&
