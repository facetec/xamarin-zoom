...
#
sharpie bind -output ./ -sdk iphoneos11.2 -namespace Zoom ./BridgeProject/ZoomAuthenticationBridge/ZoomAuthenticationBridge/ZoomAuthenticationBridge.h -scope ./ZoomAuthentication.framework/Headers/  -scope ./BridgeProject/
